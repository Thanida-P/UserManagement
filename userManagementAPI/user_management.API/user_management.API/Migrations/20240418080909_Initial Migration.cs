        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermissionsId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPermission_Permissions_PermissionsId",
                        column: x => x.PermissionsId,
                        principalTable: "Permissions",
                        principalColumn: "PermissionsId");
                    table.ForeignKey(
                        name: "FK_UserPermission_Users_UsersId",
                        column: x => x.UsersId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPermission_PermissionsId",
                table: "UserPermission",
                column: "PermissionsId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPermission_UsersId",
                table: "UserPermission",
                column: "UsersId");
